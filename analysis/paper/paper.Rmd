...
# load R scripts
#source(system.file("R", "analysis.R", package = "byocstarch"))
#source("../../analysis/scripts/analysis.R")
#source("../../analysis/scripts/amylase-assay.R")
#source("../../analysis/scripts/figures.R")
#source("../../analysis/scripts/tables.R")
