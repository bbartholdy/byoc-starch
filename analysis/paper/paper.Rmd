...
The mixed treatment had the highest absolute count of starch granules in solution (mean = `r subset(count_sol, treatment == "mix")$total`),
...
(`r subset(count_sol, treatment == "potato")$total`)
