...
The mixed treatment had the highest absolute count of starch granules in solution (mean = `r subset(count_sol, solution == "mix")$total`),
while the biofilms exposed to the wheat solution preserved the greatest number of
granules 
(mean = `r subset(count_sample, treatment == "wheat")$total`). 
The potato treatment had the lowest absolute counts in both the solution 
(`r subset(count_sol, solution == "potato")$total`)
and in the biofilm samples 
(`r subset(count_sample, treatment == "potato")$total`) 
