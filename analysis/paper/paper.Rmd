...
```{r microscope-fig, fig.cap="Microscope image of a biofilm sample exposed to the potato starch solution. Potato granules can be seen within a bacterial community. Scale bar = 20 $\\mu$m.", fig.show='hold', out.width="40%"}
knitr::include_graphics(c(here("analysis/figures/starches_w_bar.jpg"), here("analysis/supplementary-materials/figures/SNAP-103412-0006.jpg")), )
```
