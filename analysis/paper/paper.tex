...
\begin{figure}
\includegraphics[width=0.5\linewidth]{/home/bjorn/Documents/Uni/publications/PhD/byocstarch/analysis/figures/starches_w_bar} \caption{Microscope image of a biofilm sample exposed to the potato starch solution. Potato granules can be seen within a bacterial community. Scale bar = 20 $\mu$m.}\label{fig:microscope-fig}
\end{figure}
